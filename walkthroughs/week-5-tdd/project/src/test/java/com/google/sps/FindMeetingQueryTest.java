...
public final class FindMeetingQueryTest {
  ...
  @Test
  public void ignoreOptionalFullDayEvent() {
    // Have each mandatory attendee have different events 
    // and an optional attendee C who has an all-day event. 
    // We should see 3 options because each person has
    // split the restricted times.
  ...
  public void considerOptionalAttendee() {
    // Have each mandatory attendee have different events 
    // and an optional attendee C who has who has an event 
    // between 8:30 and 9:00. Only the early and late parts
    // of the day should be returned.
    //
    // Events  :       |--A--|     |--B--|
    // Optional:             |--C--|
    // Day     : |-----------------------------|
  ...
  @Test
  public void ignoreOptionalNotEnoughDuration() {
    // Have one mandatory person, but make it so that there is just enough 
  ...
  public void everyOptionalIsConsidered() {
    // No mandatory attendees, just two optional attendees with 
    // several gaps in their schedules. 
  ...
  @Test
  public void ignoreTwoOptionalFullDay() {
    // No mandatory attendees, just two optional attendees with no
    // gaps in their schedules. query should return that the whole day
    // is available since the optional attendees cannot be accommodated 
